...
<pre markdown="0"><code class="language-cpp">
#pragma once
#include "Obj.h"
...
<pre markdown="0"><code class="language-cpp">
void CColt_Bullet::Render(HDC hDC) {
...
<pre markdown="0"><code class="language-cpp">
void CBoss_Belial::Create_Bullet() {
...
<pre markdown="0"><code class="language-cpp">
void CStageMgr::Set_Stage(STAGEID eID) {
	m_eCurStage = eID;
